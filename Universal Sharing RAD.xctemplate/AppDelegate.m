...
//    [Crashlytics startWithAPIKey:@"4f28f3c2652a69f3e4859518f470cd56aad8f654"];
    
    [DBHelper initializeDatabase];
    [Utility initializeUserStatsDictionary];
    
    [AppTracker startSession:@"Pw2B23j4l7A0MZV2zo0SXvG96wfQgaTC"];
    
    [AdColony configureWithAppID:@"app5c34d57eda094f45a5"
                         zoneIDs:@[@"vz1eb2539adedf47b5ae"]
                        delegate:nil
                         logging:YES];
